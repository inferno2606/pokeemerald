...
static void PlayerHandleCheckOpp(u32 battler);
...
static void (*const sPlayerBufferCommands[CONTROLLER_CMDS_COUNT])(u32 battler) =
{
    ...
    [CONTROLLER_CHECK_OPP]                = PlayerHandleCheckOpp,
...
static void HandleInputChooseAction(u32 battler)
{
    ...
    {
        BtlController_EmitTwoReturnValues(battler, BUFFER_B, B_ACTION_CHECK_OPP, 0);
        PlayerBufferExecCompleted(battler);
    }
