...
{   // { width, height, offset }
    ...
    [TYPE_MONKE + 1]    = { 32, 12, 0x4  },
    [TYPE_BIRB + 1]     = { 32, 12, 0x4  },
    [TYPE_DINOSAUR + 1] = { 32, 12, 0x4  },
    [TYPE_FROG + 1]     = { 32, 12, 0x4  },
    [TYPE_ARMORED + 1]  = { 32, 12, 0x4  },
    [TYPE_ART + 1]      = { 32, 12, 0x4  },
    [TYPE_ANCIENT + 1]  = { 32, 12, 0x4  },
    [TYPE_LITTLE + 1]   = { 32, 12, 0x4  },
    [TYPE_ANGY + 1]     = { 32, 12, 0x4  },
    [TYPE_BABY + 1]     = { 32, 12, 0x4  },
    [TYPE_YOKAI + 1]    = { 32, 12, 0x4  },
    [TYPE_CHARGED + 1]  = { 32, 12, 0x4  },
    [TYPE_ROYAL + 1]    = { 32, 12, 0x4  },
    [TYPE_SPACE + 1]    = { 32, 12, 0x4  },
    [TYPE_STEALTH + 1]  = { 32, 12, 0x4  },
    [TYPE_SOUND + 1]    = { 32, 12, 0x4  },
    [TYPE_MAGIC + 1]    = { 32, 12, 0x4  },
    [TYPE_TYPE + 1]     = { 32, 12, 0x4  },
    [TYPE_GUN + 1]      = { 32, 12, 0x4  },
