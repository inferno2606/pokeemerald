...
static const u8 sATypeMove_Table[NUMBER_OF_MON_TYPES][17] =
{
    ...
    [TYPE_MONKE]    = _("a MONKE move"),
    [TYPE_BIRB]     = _("a BIRB move"),
    [TYPE_DINOSAUR] = _("a DINO move"),
    [TYPE_FROG]     = _("a FROG move"),
    [TYPE_ARMORED]  = _("an ARMORED move"),
    [TYPE_ART]      = _("an ART move"),
    [TYPE_ANCIENT]  = _("an ANCIENT move"),
    [TYPE_LITTLE]   = _("a LITTLE move"),
    [TYPE_ANGY]     = _("an ANGY move"),
    [TYPE_BABY]     = _("a BABY move"),
    [TYPE_YOKAI]    = _("a YOKAI move"),
    [TYPE_CHARGED]  = _("a CHARGED move"),
    ...
    [TYPE_TYPE]     = _("a TYPE move"),
    [TYPE_GUN]      = _("a GUN move"),
};
