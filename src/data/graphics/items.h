...
const u32 gItemIcon_Saw[] = INCBIN_U32("graphics/items/icons/old_rod.4bpp.lz");
const u32 gItemIconPalette_Saw[] = INCBIN_U32("graphics/items/icon_palettes/old_rod.gbapal.lz");
