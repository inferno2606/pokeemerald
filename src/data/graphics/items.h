...
const u32 gItemIcon_Saw[] = INCBIN_U32("graphics/items/icons/saw.4bpp.lz");
const u32 gItemIconPalette_Saw[] = INCBIN_U32("graphics/items/icon_palettes/saw.gbapal.lz");
