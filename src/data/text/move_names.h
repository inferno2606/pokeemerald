...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PSYBLADE] = _("Psyblade"),
    [MOVE_HYDRO_STEAM] = _("Hydro Steam"),
    [MOVE_UNGA_BUNGA] = _("Unga Bunga"),
    [MOVE_MUMMIFY] = _("Mummify"),
    [MOVE_IMPOSE] = _("Impose"),
    [MOVE_IMPRESSIONISM] = _("Impressnism"),
    [MOVE_REALISM] = _("Realism"),
    [MOVE_CUBISM] = _("Cubism"),
    [MOVE_PACK_TACTICS] = _("Pack Tactics"),
    [MOVE_FLAME_BLADE] = _("Flame Blade"),
    [MOVE_EXTINCTION_EVENT] = _("ExtincEvent"),
    [MOVE_JURASSIC_BEAM] = _("JurassicBeam"),
    [MOVE_HOP] = _("Hop"),
    [MOVE_TONGUE_SWAT] = _("Tongue Swat"),
    [MOVE_FRUBBLES] = _("Frubbles"),
    [MOVE_HIDDEN_BLADE] = _("Hidden Blade"),
