...
static const u8 sUngaBungaDescription[] = _(
    "Oo oo ah ah");

static const u8 sMummifyDescription[] = _(
    "Wraps the opponent in cloth\n"
    "and embalming oinments.");

static const u8 sImposeDescription[] = _(
    "Paints a drawing on the\n"
    "opponent.");

static const u8 sImpressionismDescription[] = _(
    "Slightly sharpens and defines\n"
    "the user's techniques.");

static const u8 sRealismDescription[] = _(
    "Sharpens and defines\n"
    "the user's techniques.");

static const u8 sCubismDescription[] = _(
    "Devolves the target into\n"
    "its basic shapes.");

static const u8 sPackTacticsDescription[] = _(
    "The user relies on \n"
    "its pack to attack in waves");

static const u8 sFlameBladeDescription[] = _(
    "Slashes with a flames.\n"
    "High critical-hit ratio.");

static const u8 sExtinctionEventDescription[] = _(
    "Calls on asteroids to\n"
    "cause a mass extinction.");

static const u8 sJurassicBeamDescription[] = _(
    "Ancient energy released\n"
    "in the form of a beam.");

static const u8 sHopDescription[] = _(
    "Hop hop hop.");

static const u8 sTongueSwatDescription[] = _(
    "Watch out bugs.");

static const u8 sFrubblesDescription[] = _(
    "Traps the opponent in\n"
    "frubbles.");

static const u8 sHiddenBladeDescription[] = _(
    "Channel your inner\n"
    "assassin.");

static const u8 sTreasureBlastDescription[] = _(
    "Stay back peasants!");

static const u8 sShellShockDescription[] = _(
    "A move rumored to be perfected\n"
    "by a plumber in red.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_UNGA_BUNGA - 1] = sUngaBungaDescription,
    [MOVE_MUMMIFY - 1] = sMummifyDescription,
    [MOVE_IMPOSE - 1] = sImposeDescription,
    [MOVE_IMPRESSIONISM - 1] = sImpressionismDescription,
    [MOVE_REALISM - 1] = sRealismDescription,
    [MOVE_CUBISM - 1] = sCubismDescription,
    [MOVE_PACK_TACTICS - 1] = sPackTacticsDescription,
    [MOVE_FLAME_BLADE - 1] = sFlameBladeDescription,
    [MOVE_EXTINCTION_EVENT - 1] = sExtinctionEventDescription,
    [MOVE_JURASSIC_BEAM - 1] = sJurassicBeamDescription,
    [MOVE_HOP - 1] = sHopDescription,
    [MOVE_TONGUE_SWAT - 1] = sTongueSwatDescription,
    [MOVE_FRUBBLES - 1] = sFrubblesDescription,
    [MOVE_HIDDEN_BLADE - 1] = sHiddenBladeDescription,
