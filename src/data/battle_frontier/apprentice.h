...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_UNGA_BUNGA] = FALSE,
    [MOVE_MUMMIFY] = TRUE,
    [MOVE_IMPOSE] = TRUE,
    [MOVE_IMPRESSIONISM] = TRUE,
    [MOVE_REALISM] = TRUE,
    [MOVE_CUBISM] = TRUE,
    [MOVE_PACK_TACTICS] = TRUE,
    [MOVE_FLAME_BLADE] = TRUE,
    [MOVE_EXTINCTION_EVENT] = TRUE,
    [MOVE_JURASSIC_BEAM] = TRUE,
    [MOVE_HOP] = TRUE,
    [MOVE_TONGUE_SWAT] = TRUE,
    [MOVE_FRUBBLES] = TRUE,
    [MOVE_HIDDEN_BLADE] = TRUE,
    [MOVE_TREASURE_BLAST] = TRUE,
    [MOVE_SHELL_SHOCK] = TRUE,
    [MOVE_SPARKLE_SMASH] = TRUE,
    [MOVE_HOT_FIST] = TRUE,
    [MOVE_DUSTINGS] = TRUE,
    [MOVE_POISON_SLAP] = TRUE,
    [MOVE_BASH] = TRUE,
};
