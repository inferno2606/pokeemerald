...
static const struct ListMenuItem sTradingBoardTypes[NUMBER_OF_MON_TYPES] = {
    ...
    { gTypeNames[TYPE_MONKE],    TYPE_MONKE          },
    { gTypeNames[TYPE_BIRB],     TYPE_BIRB           },
    { gTypeNames[TYPE_DINOSAUR], TYPE_DINOSAUR       },
    { gTypeNames[TYPE_FROG],     TYPE_FROG           },
    { gTypeNames[TYPE_ARMORED],  TYPE_ARMORED        },
    { gTypeNames[TYPE_ART],      TYPE_ART            },
    { gTypeNames[TYPE_ANCIENT],  TYPE_ANCIENT        },
    { gTypeNames[TYPE_LITTLE],   TYPE_LITTLE         },
    { gTypeNames[TYPE_ANGY],     TYPE_ANGY           },
    { gTypeNames[TYPE_BABY],     TYPE_BABY           },
    { gTypeNames[TYPE_YOKAI],    TYPE_YOKAI          },
    { gTypeNames[TYPE_CHARGED],  TYPE_CHARGED        },
    { gTypeNames[TYPE_ROYAL],    TYPE_ROYAL          },
    { gTypeNames[TYPE_SPACE],    TYPE_SPACE          },
    { gTypeNames[TYPE_STEALTH],  TYPE_STEALTH        },
    { gTypeNames[TYPE_SOUND],    TYPE_SOUND          },
    { gTypeNames[TYPE_MAGIC],    TYPE_MAGIC          },
    { gTypeNames[TYPE_TYPE],     TYPE_TYPE           },
    { gTypeNames[TYPE_GUN],      TYPE_GUN            },
