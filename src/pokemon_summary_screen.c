...
static const union AnimCmd sSpriteAnim_TypeBirb[] = {
    ANIMCMD_FRAME(TYPE_BIRB * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeDinosaur[] = {
    ANIMCMD_FRAME(TYPE_DINOSAUR * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};
...
static const union AnimCmd sSpriteAnim_TypeArmored[] = {
    ANIMCMD_FRAME(TYPE_ARMORED * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeArt[] = {
    ANIMCMD_FRAME(TYPE_ART * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeAncient[] = {
    ANIMCMD_FRAME(TYPE_ANCIENT * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeLittle[] = {
    ANIMCMD_FRAME(TYPE_LITTLE * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeAngy[] = {
    ANIMCMD_FRAME(TYPE_ANGY * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeBaby[] = {
    ANIMCMD_FRAME(TYPE_BABY * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeYokai[] = {
    ANIMCMD_FRAME(TYPE_YOKAI * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeCharged[] = {
    ANIMCMD_FRAME(TYPE_CHARGED * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_TypeRoyal[] = {
    ANIMCMD_FRAME(TYPE_ROYAL * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};
...
static const union AnimCmd sSpriteAnim_TypeStealth[] = {
    ANIMCMD_FRAME(TYPE_STEALTH * 8, 0, FALSE, FALSE),
    ANIMCMD_END
};
...
static const union AnimCmd *const sSpriteAnimTable_MoveTypes[NUMBER_OF_MON_TYPES + CONTEST_CATEGORIES_COUNT] = {
    ...
    sSpriteAnim_TypeBirb,
    sSpriteAnim_TypeDinosaur,
    sSpriteAnim_TypeFrog,
    sSpriteAnim_TypeArmored,
    sSpriteAnim_TypeArt,
    sSpriteAnim_TypeAncient,
    sSpriteAnim_TypeLittle,
    sSpriteAnim_TypeAngy,
    sSpriteAnim_TypeBaby,
    sSpriteAnim_TypeYokai,
    sSpriteAnim_TypeCharged,
    sSpriteAnim_TypeRoyal,
